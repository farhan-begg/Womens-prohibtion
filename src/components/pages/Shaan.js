...
export default function Shaan() {
  return (
    <div className="shaan-container">
      ...
      <img src="https://www.nps.gov/bepa/learn/images/Alice-Paul-raises-glass1az.jpg?maxwidth=1200&maxheight=1200&autorotate=false"  className='shaan-image' alt="not working"/>
      <p>
        ...
        that were radical to the original womanhood, this new generation became to be known as 'the new women'. Women no longer found the traditional motherhood
        ...
        motherhood all together by getting illegal abortions or taking contraceptives. Womens fashion made radical reforms during this era; a new style of dress was created
